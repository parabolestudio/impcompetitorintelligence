...
export const countryShapeMapping = {
  ...
  Belgium: {
    shapeFile: "Belgium.svg",
    countryLabel: "Belgium",
    aspectRatio: 44 / 36,
    showCities: false,
  },
  Netherlands: {
    shapeFile: "Netherlands.svg",
    countryLabel: "Netherlands",
    aspectRatio: 35 / 41,
    showCities: false,
  },
  Sweden: {
    shapeFile: "Sweden.svg",
    countryLabel: "Sweden",
    aspectRatio: 25 / 54,
    showCities: false,
  },
  ...
  Singapore: {
    shapeFile: "Singapore.svg",
    countryLabel: "Singapore",
    aspectRatio: 79 / 50,
    showCities: false,
  },
  Australia: {
    shapeFile: "Australia.svg",
    countryLabel: "Australia",
    aspectRatio: 99 / 93,
    showCities: false,
  },
  Switzerland: {
    shapeFile: "Switzerland.svg",
    countryLabel: "Switzerland",
    aspectRatio: 77 / 50,
    showCities: false,
  },
  Luxembourg: {
    shapeFile: "Luxembourg.svg",
